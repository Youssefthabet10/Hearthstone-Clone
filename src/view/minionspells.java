	...
	public static void display(Hero cur, Hero opphero, Card c) {
		...
		if (oppfield1.isVisible()) {
			oppfield1.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(0);
				try {
					cur.castSpell(s, m);
		...
		if (oppfield2.isVisible()) {
			oppfield2.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(1);
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield3.isVisible()) {
			oppfield3.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(2);
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield4.isVisible()) {
			oppfield4.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(3);
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield5.isVisible()) {
			oppfield5.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(4);
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield6.isVisible()) {
			oppfield6.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(5);
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
		...
		if (oppfield7.isVisible()) {
			oppfield7.setOnMouseClicked(e2 -> {
				Minion m = opphero.getField().get(6);
				try {
					cur.castSpell(s, m);
				} catch (NotEnoughManaException e1) {
					AlertMana.display();
