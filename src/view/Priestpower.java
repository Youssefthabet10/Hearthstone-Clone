...
public static  void display(Hero cur){
	...
	if(curfield2.isVisible()){
		...
		Priest use = (Priest) cur;
			try {
				use.useHeroPower(use.getField().get(1));
			}catch ( NotEnoughManaException e1) {
				AlertMana.display();
				e1.printStackTrace();
			}catch (HeroPowerAlreadyUsedException e8) {
	...
	if(curfield3.isVisible()){
		...
		Priest use = (Priest) cur;
			try {
				use.useHeroPower(use.getField().get(2));
			}catch ( NotEnoughManaException e1) {
				AlertMana.display();
				e1.printStackTrace();
			}catch (HeroPowerAlreadyUsedException e8) {
	...
	if(curfield4.isVisible()){
		...
		Priest use = (Priest) cur;
			try {
				use.useHeroPower(use.getField().get(3));
			}catch ( NotEnoughManaException e1) {
				AlertMana.display();
				e1.printStackTrace();
			}catch (HeroPowerAlreadyUsedException e8) {
	...
	if(curfield5.isVisible()){
		...
		Priest use = (Priest) cur;
			try {
				use.useHeroPower(use.getField().get(4));
			}catch ( NotEnoughManaException e1) {
				AlertMana.display();
				e1.printStackTrace();
			}catch (HeroPowerAlreadyUsedException e8) {
	...
	if(curfield6.isVisible()){
		...
		Priest use = (Priest) cur;
			try {
				use.useHeroPower(use.getField().get(5));
			}catch ( NotEnoughManaException e1) {
				AlertMana.display();
				e1.printStackTrace();
			}catch (HeroPowerAlreadyUsedException e8) {
	...
	if(curfield7.isVisible()){
		...
		Priest use = (Priest) cur;
			try {
				use.useHeroPower(use.getField().get(6));
			}catch ( NotEnoughManaException e1) {
				AlertMana.display();
				e1.printStackTrace();
			}catch (HeroPowerAlreadyUsedException e8) {
